...
export default function AutomationsPage({
  ...
  const [automation, setAutomations] = useState<Automation | null>(null)
  ...
  useEffect(() => {
    async function load() {
      try {
        ...
        setAutomations(autRes.data as Automation | null)
                ...
                >
                  ...
                  <div className="min-w-0 flex-1">
                    <div className="truncate text-sm font-medium text-foreground">
                      {log.contact?.name ?? log.contact?.phone ?? "Desconhecido contact"}
                    </div>
