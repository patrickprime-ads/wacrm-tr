 ...
 */
function FunilChart({ steps }: { steps: FunilStep[] }) {
...
export default function BroadcastDetailPage() {
  ...
  async function handleDelete() {
    ...
    // changes, not on a cascaded drop de the parent row.
          ...
          <Button
            ...
            title={
              broadcast.status === 'sending'
                ? 'Não é possível excluir enquanto uma transmissão está em envio'
          ...
          <div className="flex h-32 items-center justify-center">
            <p className="text-sm text-muted-foreground">
              {recipients.length === 0
                ...
                : 'Nenhum destinat?rio corresponde a este filtro.'}
            </p>
          </div>
        ) : (
