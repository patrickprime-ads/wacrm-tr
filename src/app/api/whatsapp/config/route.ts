...
export async function GET() {
  try {
    ...
    try {
      ...
      const message = err instanceof Error ? err.message : 'Desconhecido Meta API error'
...
export async function POST(request: Request) {
  try {
    ...
    try {
      ...
      const message = err instanceof Error ? err.message : 'Desconhecido encryption error'
    ...
    if (needsRegistration) {
      if (!pin) {
        ...
        try {
          ...
          registrationError =
            err instanceof Error ? err.message : 'Desconhecido Meta API error'
