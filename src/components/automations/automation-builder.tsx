...
// ------------------------------------------------------------
// Step metadata — one source de truth for icon + label + border color
// ------------------------------------------------------------
  ...
  return (
    <div className="fixed inset-0 flex flex-col bg-background">
      {/* Top bar. At sub-sm widths the "Active" label is hidden and the
          switch moves to the right de the save button, so the name input
          gets maximum width. */}
      ...
      <div className="rounded-lg border border-border border-l-4 border-l-blue-500 bg-card shadow-lg">
        ...
        >
          ...
          <div className="min-w-0 flex-1">
            <div className="text-[11px] uppercase tracking-wide text-blue-300">Acionamento</div>
          ...
          >
            ...
            <div className="min-w-0 flex-1">
              <div className="text-[11px] uppercase tracking-wide text-muted-foreground">
                {isCondition ? "Condi??o" : step.step_type === "wait" ? "Espera" : "Ação"}
              </div>
...
function ConditionBranches({
  ...
  // StepList users is driven by the LAST element of parentPath, so the
