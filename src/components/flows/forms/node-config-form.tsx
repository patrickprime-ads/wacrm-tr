...
export function NodeConfigForm({
  ...
  switch (node.node_type) {
        ...
        <>
          ...
          <div>
            ...
            <p className="mt-1 text-[10px] text-muted-foreground">
              Use em prompts seguintes e notas de transferência com{" "}
          ...
          <NextNodeRow
            ...
            currentKey={node.node_key}
            onChange={(v) => onUpdateConfig({ next_node_key: v })}
            label="Depois de coletar, avançar para"
          />
        </>
      );
    ...
    case "handoff":
      return (
        <TextRow
          label="Nota interna para o atendente"
    ...
    case "end":
      return (
        <p className="text-xs text-muted-foreground">
          Nó terminal. Quando o executor chega a este nó, a execução é marcada como concluída. Não precisa de configuração.
        </p>
      );
  }
}
  ...
  return (
    <>
      ...
      <NextNodeRow
        ...
        currentKey={currentKey}
        onChange={(v) => onUpdateConfig({ next_node_key: v })}
        label="Depois de enviar, avançar para"
      />
    </>
  );
}
