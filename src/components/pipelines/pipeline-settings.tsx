...
import { displayPipelineName, displayStageName } from "@/lib/pipelines/display";
...
export function PipelineSettings({
  ...
  useEffect(() => {
    ...
    setLocalStages(
      [...stages]
        ...
        .map((stage) => ({ ...stage, name: displayStageName(stage.name) })),
    );
  ...
  async function handleRemoveStage(stageId: string) {
    // Refuser? to delete if deals still reference the stage (FK would fail).
