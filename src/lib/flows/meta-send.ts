...
// ------------------------------------------------------------
// Fluxos-side Meta sender (interactive variants).
//
...
/**
 * Send a plain-text WhatsApp message from the Fluxos engine.
 *
...
/**
 * Send an image / video / document from the Fluxos engine.
 *
...
/**
 * Send an interactive-button WhatsApp message from the Fluxos engine.
 *
...
/**
 * Send an interactive-list WhatsApp message from the Fluxos engine.
