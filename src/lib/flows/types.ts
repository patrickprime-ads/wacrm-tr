...
// ============================================================
// Engine input — what `dispatchInboundToFluxos` accepts
// ============================================================
...
export interface DispatchInboundResult {
   ...
   * Webhook users this to decide whether to also fire automations.
   */
  consumed: boolean;
