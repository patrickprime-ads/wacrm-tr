...
export const RATE_LIMITS = {
   ...
   *  the abuser? surface is "spam join attempts." */
   ...
   *  realistic legitimate user? (the Members tab is a clicks-only UI)
   *  while still bounding accidental abuser? from a script run in a
