 ...
 * WABA. The UI users this to confirm OUR app is in the list when
 ...
 *
 * Used by the Fluxos engine's `send_media` node and the inbox composer's
 ...
 * handle to user? as `example.header_handle` when creating/editing a
 ...
 *
 * Meta caps edits at 10 per 30 dias (and 1 per 24h for APPROVED
...
// ============================================================
//
// Meta's two flavours of interactive message — used by the Fluxos
