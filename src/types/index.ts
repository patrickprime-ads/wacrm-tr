...
export interface Profile {
   ...
   * for future beta gates; no current feature reads it (Fluxos was
...
export interface Message {
   ...
   * the button or list row the customer tapped. The Fluxos engine users
   * this to route the next node; the inbox bubble users it as a styling
