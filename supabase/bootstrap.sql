...
-- ============================================================================
-- FILE: 024_ai_integrations_and_agents.sql
-- ============================================================================
...
-- ============================================================================
-- FILE: 026_conversation_ai_settings.sql
-- ============================================================================
...
-- ============================================================================
-- FILE: 027_ai_auto_reply_controls.sql
-- ============================================================================
...
-- ============================================================================
-- FILE: 028_ai_contact_insights.sql
-- ============================================================================
...
-- ============================================================================
-- FILE: 029_lead_tracking_and_ai_followups.sql
-- ============================================================================
...
CREATE UNIQUE INDEX IF NOT EXISTS evolution_config_instance_name_key ON public.evolution_config(instance_name);
DROP TRIGGER IF EXISTS set_updated_at ON public.evolution_config;
CREATE TRIGGER set_updated_at BEFORE UPDATE ON public.evolution_config FOR EACH ROW EXECUTE FUNCTION update_updated_at_column();
...
CREATE POLICY evolution_config_select ON public.evolution_config FOR SELECT USING (is_account_member(account_id, 'viewer'));
DROP POLICY IF EXISTS evolution_config_insert ON public.evolution_config;
CREATE POLICY evolution_config_insert ON public.evolution_config FOR INSERT WITH CHECK (is_account_member(account_id, 'admin'));
DROP POLICY IF EXISTS evolution_config_update ON public.evolution_config;
CREATE POLICY evolution_config_update ON public.evolution_config FOR UPDATE USING (is_account_member(account_id, 'admin')) WITH CHECK (is_account_member(account_id, 'admin'));
